...
{
    //private static readonly string BANEDWORDS_FILE_PATH = "./BHR-DATA/BanWords.txt";
    ...
    //        try
    //        {
    //            if (!Directory.Exists(@"BHR-DATA")) Directory.CreateDirectory(@"BHR-DATA");
    ...
    //                File.WriteAllText(BANEDWORDS_FILE_PATH, GetResourcesTxt($"BHR.Resources.Config.BanWords.{fileName}.txt"));
    //            }
    //        }
    //        catch (Exception ex)
    //        {
