...
using static BHR.Roles.Core.CustomRoleManager;
...
public static class CustomRolesHelper
{
    ...
    public static CustomRoles GetVNRole(this CustomRoles role) // RoleBase: Impostor, Shapeshifter, Crewmate, Engineer, Scientist
    {
        ...
        return role switch
        {
            CustomRoles.ShapeshifterBHR => CustomRoles.Shapeshifter,
            CustomRoles.PhantomBHR => CustomRoles.Phantom,
            CustomRoles.ScientistBHR => CustomRoles.Scientist,
            CustomRoles.EngineerBHR => CustomRoles.Engineer,
            CustomRoles.NoisemakerBHR => CustomRoles.Noisemaker,
    ...
    public static bool HasImpBasis(this CustomRoles role, bool ForDesyncRole = true)
        => role.GetVNRole() is CustomRoles.Impostor
            ...
            or CustomRoles.Phantom or CustomRoles.ViperBHR
    ...
    {
        return target.Is(CustomRoles.EngineerBHR)
        ...
        switch (role)
        {
            ...
            case CustomRoles.Autopsy:
                if (pc.Is(CustomRoles.Doctor)
                    ...
                    || pc.Is(CustomRoles.ScientistBHR)
            ...
            case CustomRoles.Bait:
                if (pc.Is(CustomRoles.Trapper)
                    ...
                    || pc.Is(CustomRoles.GuardianAngelBHR))
                    return false;
                break;
            ...
            case CustomRoles.Tiebreaker:
                if (pc.Is(CustomRoles.Dictator)
                    ...
                    || pc.Is(CustomRoles.Influenced)
                    || pc.Is(CustomRoles.GuardianAngelBHR)) return false;
                break;
            ...
            case CustomRoles.Flash:
                if (pc.Is(CustomRoles.Swooper)
                    ...
                    || pc.Is(CustomRoles.ShapeshifterBHR)
