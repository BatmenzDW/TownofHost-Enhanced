...
public static class Madmate
{
    ...
    public static OptionItem JudgeOldCanBeMadmate;
    ...
    public static void SetupCustomMenuOptions()
    {
        ...
        JudgeOldCanBeMadmate = BooleanOptionItem.Create(Id2 + 13, "JudgeOldCanBeMadmate", false, TabGroup.Addons, false).SetParent(CustomRoleSpawnChances[CustomRoles.Madmate]);
    }
    ...
    public static bool CheckCanBeMadmate(this PlayerControl pc, bool forGangster = false)
    {
        return
            ...
            (pc.Is(CustomRoles.JudgeOld) && (!forGangster ? !JudgeOldCanBeMadmate.GetBool() : !Gangster.JudgeOldCanBeMadmate.GetBool())) ||
