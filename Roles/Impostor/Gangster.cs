...
internal class Gangster : RoleBase
{
    ...
    public override void SetupCustomOption()
    {
        ...
        ProsecutorCanBeMadmate = BooleanOptionItem.Create(Id + 17, "GanProsecutorCanBeMadmate", false, TabGroup.ImpostorRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.Gangster]);
