...
internal class Godfather : RoleBase
{
    ...
    public override bool CheckVote(PlayerControl votePlayer, PlayerControl voteTarget)
    {
        ...
        SendMessage(GetString("VoteHasReturned"), votePlayer.PlayerId, title: ColorString(GetRoleColor(CustomRoles.Godfather), string.Format(GetString("VoteAbilityUsed"), GetString("Godfather"))), addToHistory: false);
        return false;
    }
}
