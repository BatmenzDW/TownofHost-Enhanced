...
public class LobbyStartPatch
{
    ...
    {
        LobbyPaintSprite = Utils.LoadSprite("BHR.Resources.Images.LobbyPaint.png", 290f);
        DropshipDecorationsSprite = Utils.LoadSprite("BHR.Resources.Images.Dropship-Decorations.png", 60f);
    }
