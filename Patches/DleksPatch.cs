...
class AllMapIconsPatch
{
    ...
    public static void Postfix_AllMapIcons(GameStartManager __instance)
    {
        ...
        DleksIncon.MapImage = Utils.LoadSprite($"BHR.Resources.Images.DleksBanner.png", 100f);
        DleksIncon.NameImage = Utils.LoadSprite($"BHR.Resources.Images.DleksBanner-Wordart.png", 100f);
